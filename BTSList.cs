...
namespace BinarySearchTree
{
    ...
    /// </summary>
    public class BSTList : IEnumerable<KeyValuePair<int, string>>
    {
        ...
        public IEnumerator<KeyValuePair<int, string>> GetEnumerator()
        {
            ...
            IBSTNode currElement;

            // pop elements from stack and return
            while (!stack.isEmpty())
            {
                currElement = stack.Pop();
                yield return new KeyValuePair<int, string>(currElement.Key, currElement.Value);
            }
